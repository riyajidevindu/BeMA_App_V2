...
class _QuestionScreen15State extends State<QuestionScreen15>
  ...
  void handleContinue() {
    ...
    if (questionnaireProvider.smokingStatus == "no_never") {
      ...
      context.goNamed(RouteNames.questionScreen16);
    }
  }
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                _buildStrokedText("Do you smoke?", screenWidth * 0.08),
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _buildSmokingOption(
                        ...
                        option["label"]!,
                        option["option"]!,
                        questionnaireProvider.smokingStatus,
                      );
                    },
                  ),
                ),
                ...
                GestureDetector(
                  onTap: questionnaireProvider.smokingStatus != null
                      ? handleContinue
                      : null,
                  child: Container(
  ...
  Widget _buildSmokingOption(
    ...
    return GestureDetector(
      onTap: () {
        questionnaireProvider.setSmokingStatus(option);
      },
      child: ClipRRect(
        borderRadius: BorderRadius.circular(15),
