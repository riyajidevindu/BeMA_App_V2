...
class _QuestionScreen12State extends State<QuestionScreen12>
  ...
  void initState() {
    ...
    _famMedHisController = TextEditingController(
      text: context.read<QuestionnaireProvider>().familyMedHistory ?? '',
    );
  ...
  Widget _buildFamilyHistoryInput(BuildContext context) {
    final questionnaireProvider =
        Provider.of<QuestionnaireProvider>(context, listen: false);
    ...
    return ClipRRect(
      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          child: Column(
            children: [
              _buildStrokedText("Please describe the conditions", 20),
              const SizedBox(height: 20),
              TextFormField(
