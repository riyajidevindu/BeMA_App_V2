...
class _QuestionScreen20State extends State<QuestionScreen20>
              ...
              children: [
                ...
                Expanded(
                  child: ListView.separated(
                    itemCount: activenessOptions.length,
                    separatorBuilder: (context, index) =>
                        const SizedBox(height: 15),
                    itemBuilder: (context, index) {
                      final option = activenessOptions[index];
                      return _buildActivenessOption(
                        context,
                        option["emoji"]!,
                        option["label"]!,
                        option["option"]!,
                        questionnaireProvider.activeMode,
                      );
                    },
                  ),
                ),
  ...
  Widget _buildActivenessOption(
    ...
    return GestureDetector(
      onTap: () {
        questionnaireProvider.setActiveMode(option);
      },
      child: ClipRRect(
        borderRadius: BorderRadius.circular(15),
