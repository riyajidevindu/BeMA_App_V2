...
class _QuestionScreen18State extends State<QuestionScreen18>
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                _buildStrokedText(
                    "How many glasses do you have?", screenWidth * 0.08),
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _buildAlcoholOption(
                        ...
                        option["label"]!,
                        option["option"]!,
                        questionnaireProvider.alcoholCount,
                      );
                    },
                  ),
                ),
                ...
                GestureDetector(
                  onTap: questionnaireProvider.alcoholCount != null
                      ? handleContinue
                      : null,
                  child: Container(
  ...
  Widget _buildAlcoholOption(
    ...
    return GestureDetector(
      onTap: () {
        questionnaireProvider.setAlcoholCount(option);
      },
      child: ClipRRect(
        borderRadius: BorderRadius.circular(15),
